...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/gilu.ipc",
			endpoint:    "/data/testnet/gilu.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/gilu.ipc",
			endpoint:    "/data/testnet/gilu.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gilu.ipc",
			endpoint:    "/data/testnet/gilu.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/gilu.ipc",
			endpoint:    "/data/testnet/gilu.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
