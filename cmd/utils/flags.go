...
import (
	...
	"github.com/NiluPlatform/go-nilu/common/fdlimit"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gilu account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// new format.
//
// e.g. gilu account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gilu --keystore /tmp/mykeystore --lightkdf account new
//
